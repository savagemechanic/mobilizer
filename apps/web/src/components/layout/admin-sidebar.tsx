...
export function AdminSidebarNav({ navigation, pathname, highestRole, variant = 'desktop' }: AdminSidebarNavProps) {
  return (
    <>
...
export function AdminMobileNav() {
  ...
  return <AdminSidebarNav navigation={navigation} pathname={pathname} highestRole={highestRole} variant="mobile" />
}
...
export function AdminSidebar() {
  ...
  return (
    <aside className="hidden md:flex w-64 flex-col border-r bg-slate-900 text-white">
      ...
      <AdminSidebarNav navigation={navigation} pathname={pathname} highestRole={highestRole} variant="desktop" />
    </aside>
  )
}
